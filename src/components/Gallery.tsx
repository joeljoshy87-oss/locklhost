        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-16">
            <div className="w-full h-auto md:w-[48%] lg:w-[45%] xl:w-[740px] mb-10 md:mb-0">
              ...
              <h2 className="font-cormorant font-semibold text-4xl md:text-[64px] leading-[105%] text-[#1A1A1A]">
               ...
               <p className="font-inter font-normal text-base md:text-[18px] leading-[28px] text-[#555555] max-w-2xl mt-8">
             ...
             <div className="w-full lg:w-1/3 flex justify-start lg:justify-end mt-8 lg:mt-0">
                <motion.button
